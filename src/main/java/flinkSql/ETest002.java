...
public class ETest002 {
    public static void main(String[] args) throws Exception {
        ...
        String insertSql = "insert into  order114 SELECT id,commodity_id,order_num,usercode,status,amount,phone_num,create_time," +
...
//        String queryDdl="SELECT id,commodity_id,order_num,usercode,status,amount,phone_num,create_time,addr,order_flag FROM order221";
