...
public class KfakDdlTOHiveTable001 {
...
//                ")";
        ...
        String ddlSource = "CREATE TABLE order221 (\n" +
                "    id BIGINT,\n" +
                "    commodity_id STRING,\n" +
                "    order_num INT,\n" +
                "    usercode STRING,\n" +
...
// to use hive dialect tableEnv.getConfig().setSqlDialect(SqlDialect.HIVE);
// to use default dialect tableEnv.getConfig().setSqlDialect(SqlDialect.DEFAULT);
        String queryDdl="SELECT usercode,order_flag FROM user_behavior002";
...
//
        String insertSql = "insert into  flink123 SELECT usercode, order_flag, " +
                " DATE_FORMAT(create_time, 'yyyy-MM-dd'), DATE_FORMAT(create_time, 'HH'), DATE_FORMAT(create_time, 'mm') FROM user_behavior006";
